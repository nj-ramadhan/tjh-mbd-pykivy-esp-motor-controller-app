...
class ScreenMainMenu(MDBoxLayout):
    ...
    def nav_parameter_alarm(self):
        self.screen_manager.current = 'screen_parameter_alarm'
...
class ScreenParameterAlarm(MDBoxLayout):
    screen_manager = ObjectProperty(None)

    def __init__(self, **kwargs):
        super(ScreenParameterAlarm, self).__init__(**kwargs)
        Clock.schedule_once(self.delayed_init)
    ...
    def delayed_init(self, dt):
        ...
        self.fig0.set_facecolor("#eeeeee")
        self.fig0.set_alpha(0.0)
        
        self.fig1, self.ax1 = plt.subplots()
        self.fig1.set_facecolor("#eeeeee")
        self.fig1.set_alpha(0.0)

        self.fig2, self.ax2 = plt.subplots()
        self.fig2.set_facecolor("#eeeeee")
        self.fig2.set_alpha(0.0)
        
        self.fig3, self.ax3 = plt.subplots()
        self.fig3.set_facecolor("#eeeeee")
        self.fig3.set_alpha(0.0)

        self.gauge(labels=['LOLO','LO','NORMAL','HI','HIHI'], colors=['#ED1C24', '#006300','#006300','#006300','#ED1C24'], arrow=4, title='Load [A]', ax=self.ax0)
        self.gauge(labels=['LOLO','LO','NORMAL','HI','HIHI'], colors=['#ED1C24', '#006300','#006300','#006300','#ED1C24'], arrow=2, title='Voltage [V]', ax=self.ax1)
        self.gauge(labels=['LOLO','LO','NORMAL','HI','HIHI'], colors=['#ED1C24', '#006300','#006300','#006300','#ED1C24'], arrow=2, title='Supply Voltage [V]', ax=self.ax2)
        self.gauge(labels=['LOLO','LO','NORMAL','HI','HIHI'], colors=['#ED1C24', '#006300','#006300','#006300','#ED1C24'], arrow=3, title='Frequency [Hz]', ax=self.ax3)
        
        self.ids.load_gauge_layout.add_widget(FigureCanvasKivyAgg(self.fig0))   
        self.ids.voltage_gauge_layout.add_widget(FigureCanvasKivyAgg(self.fig1))   
        self.ids.supply_voltage_gauge_layout.add_widget(FigureCanvasKivyAgg(self.fig2))   
        self.ids.frequency_gauge_layout.add_widget(FigureCanvasKivyAgg(self.fig3))   

    def nav_main_menu(self):
        self.screen_manager.current = 'screen_main_menu'
    
    def screen_load_alarm(self):
        self.screen_manager.current = 'screen_load_alarm'

    def screen_voltage_alarm(self):
        self.screen_manager.current = 'screen_voltage_alarm'

    def screen_supply_voltage_alarm(self):
        self.screen_manager.current = 'screen_supply_voltage_alarm'

    def screen_frequency_alarm(self):
        self.screen_manager.current = 'screen_frequency_alarm'

    def screen_rotation_alarm(self):
        self.screen_manager.current = 'screen_rotation_alarm'

    def screen_spin_alarm(self):
        self.screen_manager.current = 'screen_spin_alarm'

    def screen_leg_ground_alarm(self):
        self.screen_manager.current = 'screen_leg_ground_alarm'

    def screen_power_factor_alarm(self):
        self.screen_manager.current = 'screen_power_factor_alarm'

class ScreenLoadAlarm(MDBoxLayout):
    screen_manager = ObjectProperty(None)

    def __init__(self, **kwargs):
        super(ScreenLoadAlarm, self).__init__(**kwargs)
        Clock.schedule_once(self.delayed_init)
...
class ScreenVoltageAlarm(MDBoxLayout):
    screen_manager = ObjectProperty(None)

    def __init__(self, **kwargs):
        super(ScreenVoltageAlarm, self).__init__(**kwargs)
        Clock.schedule_once(self.delayed_init)
    ...
    def delayed_init(self, dt):
        ...
        # self.gauge(labels=['LOLO','LO','NORMAL','HI','HIHI'], colors=['#ED1C24', '#006300','#006300','#006300','#ED1C24'], arrow=4, title='Load [A]', ax=self.ax0)
        self.gauge(labels=['LOLO','LO','NORMAL','HI','HIHI'], colors=['#ED1C24', '#006300','#006300','#006300','#ED1C24'], arrow=2, title='Voltage [V]', ax=self.ax0)
     
        self.ids.voltage_gauge_layout.add_widget(FigureCanvasKivyAgg(self.fig0))

    def nav_main_menu(self):
        self.screen_manager.current = 'screen_main_menu'

class ScreenSupplyVoltageAlarm(MDBoxLayout):
    screen_manager = ObjectProperty(None)

    def __init__(self, **kwargs):
        super(ScreenSupplyVoltageAlarm, self).__init__(**kwargs)
        Clock.schedule_once(self.delayed_init)
    ...
    def delayed_init(self, dt):
        ...
        # self.gauge(labels=['LOLO','LO','NORMAL','HI','HIHI'], colors=['#ED1C24', '#006300','#006300','#006300','#ED1C24'], arrow=2, title='Voltage [V]', ax=self.ax0)
        self.gauge(labels=['LOLO','LO','NORMAL','HI','HIHI'], colors=['#ED1C24', '#006300','#006300','#006300','#ED1C24'], arrow=2, title='Supply Voltage [V]', ax=self.ax0)
     
        self.ids.supply_voltage_gauge_layout.add_widget(FigureCanvasKivyAgg(self.fig0))

    def nav_main_menu(self):
        self.screen_manager.current = 'screen_main_menu'

class ScreenFrequencyAlarm(MDBoxLayout):
    screen_manager = ObjectProperty(None)

    def __init__(self, **kwargs):
        super(ScreenFrequencyAlarm, self).__init__(**kwargs)
        Clock.schedule_once(self.delayed_init)
    ...
    def delayed_init(self, dt):
        ...
        self.gauge(labels=['LOLO','LO','NORMAL','HI','HIHI'], colors=['#ED1C24', '#006300','#006300','#006300','#ED1C24'], arrow=3, title='Frequency [Hz]', ax=self.ax0)
     
        self.ids.frequency_gauge_layout.add_widget(FigureCanvasKivyAgg(self.fig0))

    def nav_main_menu(self):
        self.screen_manager.current = 'screen_main_menu'

class ScreenRotationAlarm(MDBoxLayout):
    screen_manager = ObjectProperty(None)

    def __init__(self, **kwargs):
        super(ScreenRotationAlarm, self).__init__(**kwargs)

    def nav_main_menu(self):
        self.screen_manager.current = 'screen_main_menu'

class ScreenSpinAlarm(MDBoxLayout):
    screen_manager = ObjectProperty(None)

    def __init__(self, **kwargs):
        super(ScreenSpinAlarm, self).__init__(**kwargs)

    def nav_main_menu(self):
        self.screen_manager.current = 'screen_main_menu'

class ScreenLegGroundAlarm(MDBoxLayout):
    screen_manager = ObjectProperty(None)

    def __init__(self, **kwargs):
        super(ScreenLegGroundAlarm, self).__init__(**kwargs)

    def nav_main_menu(self):
        self.screen_manager.current = 'screen_main_menu'

class ScreenPowerFactorAlarm(MDBoxLayout):
    screen_manager = ObjectProperty(None)

    def __init__(self, **kwargs):
        super(ScreenPowerFactorAlarm, self).__init__(**kwargs)
